export const translations = {
  en: {
    ...
    results: {
      ...
      unverifiedMoreInfo: 'Unable to verify more information.',
      ...
      accountUnknown: 'Account Required: Unknown',
  ...
  ar: {
    ...
    results: {
      ...
      detectedUrl: 'الرابط المكتشف:',
      unverifiedMoreInfo: 'تعذر التحقق من المزيد من المعلومات.',
      ...
      accountRequired: 'يتطلب إنشاء حساب',
      accountNotRequired: 'لا يتطلب إنشاء حساب',
      accountUnknown: 'التسجيل: غير معروف',
